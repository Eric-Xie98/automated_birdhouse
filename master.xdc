...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets CPU/DX/dff[0]/Bin[0]]
...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { ledclock }]; #IO_L24P_T3_RS1_15 Sch=led[1]
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { ledreset }]; #IO_L17N_T2_A25_15 Sch=led[2]
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { ledrotor }]; #IO_L8P_T1_D11_14 Sch=led[3]
